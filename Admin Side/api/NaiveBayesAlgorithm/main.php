...
if(isset($_POST['soilPH'])){
	...
	$sql1 = "INSERT INTO sc_latest_activity (id,plant_name,activity,soil_ph_value,soil_moisture_value,soil_ph_category,result, date, time) VALUES ('$id','$plantNAME','$activity','$soilPH','~','$category', '$categoryResult', '$date','$time')";
