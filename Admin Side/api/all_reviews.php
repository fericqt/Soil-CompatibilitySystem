...
<div class="modal modal-blur fade" id="modal-danger_all_reviews" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <div class="col" ><a href="#"data-bs-dismiss="modal" class="btn btn-white w-100">
                ...
                <div class="col"><a class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#modal-success_all_reviews"  onclick="deleteClick_all_reviews(document.getElementById('delete_id').value)">
                    Delete data
                  </a></div>
          </div>
        </div>
	...
	<div class="modal modal-blur fade" id="modal-success_all_reviews" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <div class="w-100">
              <div class="row">
                <div class="col"><a href="./all_reviews.html" class="btn btn-success w-100">
                    OK
                  </a></div>
              </div>
            </div>
 ...
 <script>
	function deleteClick_all_reviews(data) {
	...
	function deleteClick1_all_reviews(data){
